% How to run
%
% splines_comp(100, [0,0,0,1,2,3,4,5,6,6,6], [1,1,1,0.1,0.1,0.1,1,1,0])
%
% splines_comp(100, [1,1,2,3,4,4], [0.5, 2,2,0.5])

function splines_comp(precision,knot_vector, coefficient_vector)
...
plot_spline = @(x, spline) plot(x, spline,'LineWidth',3);
...
for i=1:nr
  spline = spline + coefficient_vector(i) * compute_splines(knot_vector, p, i, x)
end
plot_spline(x, spline)
hold on
